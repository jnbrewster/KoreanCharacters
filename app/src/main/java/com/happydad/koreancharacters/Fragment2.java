...
public class Fragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        LinearLayout mLinearLayout = (LinearLayout) inflater.inflate(R.layout.fragment_2,
                container, false);


        //Fragment section for button / audio
        Button button_ga = (Button) mLinearLayout.findViewById(R.id.Button_na);
        ...
        Button button_gya = (Button) mLinearLayout.findViewById(R.id.Button_nya);
        ...
        Button button_geo = (Button) mLinearLayout.findViewById(R.id.Button_neo);
        ...
        Button button_gyeo = (Button) mLinearLayout.findViewById(R.id.Button_nyeo);
        ...
        Button button_goh = (Button) mLinearLayout.findViewById(R.id.Button_noh);
        ...
        Button button_gyoh = (Button) mLinearLayout.findViewById(R.id.Button_nyoh);
        ...
        Button button_goo = (Button) mLinearLayout.findViewById(R.id.Button_noo);
        ...
        Button button_gyoo = (Button) mLinearLayout.findViewById(R.id.Button_nyoo);
        ...
        Button button_geu = (Button) mLinearLayout.findViewById(R.id.Button_neu);
        ...
        Button button_gee = (Button) mLinearLayout.findViewById(R.id.Button_nee);
